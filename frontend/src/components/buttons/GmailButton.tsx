...
const GmailButton: React.FC<GmailButtonProps> = ({ student }) => {
  ...
  const handleButtonClick = async () => {
    ...
    // };
    const extraInfo = "";
    // const extraInfo = `Your current score is ${Math.round(student.p4score * 10) / 10} in Algebra 2 for P4.${extraMessage(student)} `;

    const emailBody = `Hello ${studentNameCapitalized},\n\nI hope this email finds you well. ${extraInfo}For your reference, I will list any assignments that may need your attention.\n\nP4 Major assignments and scores:\n${majorAssignments}\n\nP4 Minor assignments and scores that are under a B:\n${minorAssignments}\n\nBest regards,\nMs. T\n\nThis email was generated by my app, ScholarSync.`;
