...
const ListFailingStudents: React.FC<ListFailingStudentsProps> = ({ students }) => {
  ...
  return (
    <button onClick={handleButtonClick}>Generate Email with Failing Student Grades</button>
  );
};
